...
class PortfolioHolding(Base):
    ...
    cost_basis_per_share: Mapped[Optional[str]] = mapped_column(
    ...
    __table_args__ = (
        UniqueConstraint(
            "portfolio_id", "stock_id", name="uq_portfolio_holdings_composite"
        ),
...
class PortfolioSnapshot(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "portfolio_id", "date", name="uq_portfolio_snapshots_composite"
        ),

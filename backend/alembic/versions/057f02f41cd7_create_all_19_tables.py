...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "equity_risk_premium", sa.Numeric(precision=8, scale=4), nullable=True
        ),
        sa.Column(
            "country_risk_premium", sa.Numeric(precision=8, scale=4), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "avg_effective_tax_rate", sa.Numeric(precision=8, scale=4), nullable=True
        ),
        sa.Column(
            "avg_debt_to_equity", sa.Numeric(precision=8, scale=4), nullable=True
        ),
        sa.Column(
            "avg_operating_margin", sa.Numeric(precision=8, scale=4), nullable=True
        ),
        sa.Column("avg_roc", sa.Numeric(precision=8, scale=4), nullable=True),
        sa.Column(
            "avg_reinvestment_rate", sa.Numeric(precision=8, scale=4), nullable=True
        ),
        sa.Column("cost_of_capital", sa.Numeric(precision=8, scale=4), nullable=True),
        sa.Column(
            "fundamental_growth_rate", sa.Numeric(precision=8, scale=4), nullable=True
        ),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=True),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        "ix_dashboard_tickers_category_order",
        "dashboard_tickers",
        ["category", "display_order"],
        unique=False,
    )
    op.create_index(
        "ix_dashboard_tickers_is_active",
        "dashboard_tickers",
        ["is_active"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "spread_over_treasury", sa.Numeric(precision=8, scale=4), nullable=False
        ),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=True),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_glossary_category"), "glossary", ["category"], unique=False
    )
    op.create_table(
        "stocks",
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        "ix_stocks_sector_industry", "stocks", ["sector", "industry"], unique=False
    )
    op.create_table(
        "users",
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        "ix_dcf_valuations_stock_default",
        "dcf_valuations",
        ["stock_id", "is_default"],
        unique=False,
    )
    op.create_index(
        "ix_dcf_valuations_stock_user",
        "dcf_valuations",
        ["stock_id", "user_id"],
        unique=False,
    )
    op.create_index(
        "ix_dcf_valuations_user_saved",
        "dcf_valuations",
        ["user_id", "is_saved"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_dividends_stock_ex_date", "dividends", ["stock_id", "ex_date"], unique=False
    )
    op.create_table(
        "earnings_calendar",
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        "ix_earnings_calendar_stock_report_date",
        "earnings_calendar",
    ...
    op.create_index(
        ...
        "financial_statements",
        ["stock_id", "statement_type", "period", "fiscal_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_financial_statements_stock_id"),
        "financial_statements",
        ["stock_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_sector_mapping_composite",
        "sector_mapping",
        ["twelvedata_sector", "twelvedata_industry"],
        unique=False,
    )
    op.create_table(
        "stock_splits",
    ...
    op.create_index(
        "ix_stock_splits_stock_date", "stock_splits", ["stock_id", "date"], unique=False
    )
    op.create_table(
        "dcf_audit_log",
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_dcf_audit_log_dcf_valuation_id"),
        "dcf_audit_log",
        ["dcf_valuation_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "cost_basis_per_share", sa.Numeric(precision=14, scale=4), nullable=True
        ),
        sa.Column(
            "added_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        "ix_portfolio_holdings_portfolio_stock",
        "portfolio_holdings",
    ...
    op.create_table(
        ...
        sa.Column(
            "total_cost_basis", sa.Numeric(precision=16, scale=2), nullable=False
        ),
        sa.Column("total_gain_loss", sa.Numeric(precision=16, scale=2), nullable=False),
        sa.Column(
            "holdings_snapshot", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["portfolio_id"], ["portfolios.id"], ondelete="CASCADE"
        ),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "ix_portfolio_snapshots_portfolio_date", table_name="portfolio_snapshots"
    )
    op.drop_table("portfolio_snapshots")
    op.drop_index(
        "ix_portfolio_holdings_portfolio_stock", table_name="portfolio_holdings"
    )
    ...
    op.drop_index(
        op.f("ix_financial_statements_stock_id"), table_name="financial_statements"
    )
    op.drop_index(
        "ix_financial_statements_composite", table_name="financial_statements"
    )
    op.drop_table("financial_statements")
    op.drop_index(
        "ix_earnings_calendar_stock_report_date", table_name="earnings_calendar"
    )
